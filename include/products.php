...
<div id="fb5-ajax">	
      ...
      <div data-current="book5" class="fb5" id="fb5">      
        ...
        <p>&nbsp;</p>
                ...
                <div data-background-image="" class="">
                     ...
                     <div class="fb5-cont-page-book">
                                    ...
                                    <div class="fb5-page-book">
                                       <div id="fb5-cover">
                                          <ul>
                                            <li><a href="javascript:setPage(2)"><img data-src="img/cover-photo1.jpg"></a></li>
                                            <li><a href="javascript:youtube('zWzRrqEvfPU','560','315')"><img data-src="img/cover-photo2.jpg"></a></li>
                                            <li><a href="javascript:youtube('48I0IHmsuOE','560','315')"><img data-src="img/cover-photo3.jpg"></a></li>
                                         </ul>
                ...
                <!-- BEGIN PAGE 3 -->          
                <div data-background-image="img/pages/3.jpg" class="">
                ...
                <!-- BEGIN PAGE 4 -->          
                <div data-background-image="img/pages/4_5.jpg" class="fb5-double fb5-first">
                ...
                <!-- BEGIN PAGE 5 -->          
                <div data-background-image="img/pages/4_5.jpg" class="fb5-double fb5-second">
                ...
                <!-- BEGIN PAGE 6 -->          
                <div data-background-image="img/pages/6.jpg" class="">
        ...
        <p>&nbsp;</p>
                ...
                <!-- BEGIN PAGE 9 -->          
                <div data-background-image="img/pages/9.jpg" class="">
                ...
                <!-- BEGIN PAGE 10 -->          
                <div data-background-image="img/pages/10_11.jpg" class="fb5-double fb5-first">
                ...
                <!-- BEGIN PAGE 11 -->          
                <div data-background-image="img/pages/10_11.jpg" class="fb5-double fb5-second">
