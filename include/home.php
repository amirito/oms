...
<div class="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-sm-offset-4  text-center">
                    ...
                    <hr>
                    <p dir="rtl" align="justify">شرکت <span class="broadway">OMS</span> در سال 1976 میلادی در زمینه
                        تولید محصولات استیل آشپزخانه با ظرفیت تولید سالانه 1/850/000 محصول فعالیت خود را آغاز نمود.
                        محصولات .O.M.S با هدف ثبات در کیفیت بالا هم اکنون از بخش فروش ترکیه فراتر رفته و به بسیاری از
                        کشور های جهان صادر میگردد. </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12  text-default">
                    <div class="call_to_action" dir="rtl"><h3><strong><span class="rotate">زیبایی, ظرافت, استحکام</span></strong>
                            با محصولات <span style="font-family:broadway;color:#dd1a21;">oms</span></h3><h4>آشپزخانه خود
                            را زیبا کنید</h4></div>
                </div>
            </div>
        </div>
    ...
    <section class="light_section">
        ...
        <div class="container">
            <div class="row">
                <h2 class="section_header fancy centered"><span style="font-family:broadway;color:#dd1a21;">OMS</span>
                    جدیدترین محصولات
                    <small>برای شما غرور به ارمغان آورده ایم</small>
                </h2>
                <div class="col-md-12  text-default">
			...
			<div class='portfolio_item'>
			  <a href='?page=productdetail&id=$home_row[id]'>
				 <figure style='background-image:url(images/products/$home_row[product_image])'>
                    ...
                    <div class="centered_button"><a class="btn btn-primary" target="_blank" title="MORE WORK" href="#">مشاهده
                            محصولات</a></div>
                </div>
            </div>
        </div>
