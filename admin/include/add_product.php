...
if(isset($_POST['submit'])){
	...
	#######  INSERT INTO DB ########
	$query = "INSERT INTO `products`(`id`, `product_name_id`, `product_code`, `product_size`, `product_description`, `product_handle`, `product_colors`, `product_image`) VALUES ('','$product_name','$product_code','$product_size','$product_description','$product_handle','$product_colors','$picture[name]')";
...
<div style="padding-top:50px">
    	<form dir="rtl" method="post" role="form" class="form-horizontal " enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="control-label pull-right col-xs-2">انتخاب نام محصول:</label>
                 <div class="col-xs-4 pull-right"> 
            ...
            <div class="form-group" id="color">
               ...
               قرمز <input type="checkbox" name="9" value="#ff0000"><div class="div-colors" style="background-color:#ff0000;"></div> 
